...
![[Figure_22]_channel_length_modulation_i-V_graph](../images/2024-04-07-first/[Figure_22]_channel_length_modulation_i-V_graph.jpg)

$r_o \equiv \left[ \frac{\partial i_D}{\partial v_{DS}} \right]^{-1}_{v_{GS}=constant}=\frac{1}{\lambda I_D}=\frac{V_A}{I_D}$

![[Figure_23]_lambda_slope](../images/2024-04-07-first/[Figure_23]_lambda_slope.jpg)
...
$V_{Th,p}$은 음수인데, (-) 기호를 사용하지 않고 다시 나타내면
